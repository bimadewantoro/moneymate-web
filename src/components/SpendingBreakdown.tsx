...
export function SpendingBreakdown({ data }: SpendingBreakdownProps) {
  ...
  const handleCategoryClick = (categoryId: string | null) => {
    if (categoryId) {
      window.location.href = `/app/transactions?category=${categoryId}`;
    }
  };
            ...
            {topCategories.map((category, index) => {
              ...
              return (
                <Link
                  ...
                  href={category.categoryId ? `/app/transactions?category=${category.categoryId}` : "/app/transactions?type=expense"}
