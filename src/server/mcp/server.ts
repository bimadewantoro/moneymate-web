...
export function createMcpServer(userId: string): McpServer {
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getUserFinanceAccounts(userId));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getUserAccountsWithBalances(userId));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getUserCategories(userId));
    }
  );
  ...
  server.tool(
    ...
    async ({ type }) => {
      return safeTool(() => getCategoriesByType(userId, type));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getUserTransactionStats(userId));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getGoals(userId));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getIncomeByCategory(userId));
    }
  );
  ...
  server.tool(
    ...
    async ({ months }) => {
      return safeTool(() => getMonthlyTrends(userId, months));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getCurrentMonthStats(userId));
    }
  );
  ...
  server.tool(
    ...
    async ({ months }) => {
      return safeTool(() => getNetWorthProgression(userId, months));
    }
  );
  ...
  server.tool(
    ...
    {},
    async () => {
      return safeTool(() => getWatchlistCategories(userId));
    }
  );
...
async function main() {
  ...
  const server = createMcpServer(currentUserId);
